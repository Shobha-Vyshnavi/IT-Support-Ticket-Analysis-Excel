...
IT Ticket Analysis PPT_shobha.pptx – Executive summary of findings and recommendations.
Tasks_shobha.docx – Detailed calculation methods and pivot table instructions.
IT Support Dashboard_shobha.xlsx – Interactive Excel dashboard.
Excel Dashboard.png – Dashboard Preview.
README.md – Documentation.
📬 Author
Shobha VYshnavi
Data & Business Analyst | Business Intelligence Developer
